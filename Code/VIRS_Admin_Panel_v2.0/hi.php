...
$query_Recordset1 = "SELECT * FROM hi ORDER BY word ASC";
...
<body><div align ="center">
  ...
  <div class="row">
       ...
       <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa"></i><small><a href="awl.php">Academic word list</a> - <a href="lo.php">Low</a> - <a href="med.php">Medium</a> - High</small></li>
                        </ol>                 
