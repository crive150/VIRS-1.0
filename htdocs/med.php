...
$query_Recordset1 = "SELECT * FROM med";
...
$totalPages_Recordset1 = ceil($totalRows_Recordset1/$maxRows_Recordset1)-1;$maxRows_Recordset1 = 100;
$pageNum_Recordset1 = 0;
if (isset($_GET['pageNum_Recordset1'])) {
  $pageNum_Recordset1 = $_GET['pageNum_Recordset1'];
}
...
<p><a href="close.php">Close this window</a></p>
<p><a href="awl.php">Academic word list</a> - <a href="lo.php">Low</a> - Medium - <a href="hi.php">High</a></p>
...
<?php do { ?>
  <p><a href="define.php?word=<?php echo $row_Recordset1['word']; ?>"><?php echo $row_Recordset1['word']; ?></a></p>
